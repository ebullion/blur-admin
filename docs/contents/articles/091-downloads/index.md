...
If you have problems installing node.js and/or other tools to build and run admin on your machine and you just want to download html/js/css files, you can find links for download on this page.
...
[admin 1.3.1](/blur-admin/downloads/blur-admin-1.3.1.zip)
[admin 1.2.0](/blur-admin/downloads/blur-admin-1.2.0.zip)
